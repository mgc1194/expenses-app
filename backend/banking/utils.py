"""
banking/utils.py — Transaction import utilities and domain-level business logic.
...
Note: Transaction itself remains a transactions-app model — only the
account-detection and upsert logic lives here, since it depends on
banking.models.Account and the handler registry.
"""
...
from transactions.models import Transaction  # Transaction model still lives in transactions app
