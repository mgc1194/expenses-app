...
Covers detect_account_type (filename-based account detection) and
upsert_transactions (dedupe-safe transaction insertion that preserves
user-managed fields like label and category on re-import).
"""
...
from banking.utils import detect_account_type, upsert_transactions
