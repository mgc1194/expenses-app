...
def auth_login(request, payload: LoginRequest):
    ...
    authenticated_user = authenticate(request, username=user.username, password=payload.password)
...
def auth_update_profile(request, payload: UpdateProfileRequest):
    ...
    All fields are optional — only fields explicitly included in the
