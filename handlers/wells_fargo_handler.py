import os
import logging
from wells_fargo.savings import process as sofi_savings
from wells_fargo.checking import process as sofi_checking
...
def __handle_files(file_path):
    try:
        ...
        if 'WF-Checking' in file_name:
            return sofi_checking(file_path)
        elif 'WF-Savings' in file_name:
